$(document).ready(function () {
	...
	function animate () {
		...
		*******************/
		...
		homeMainSquare
		*******************/
		$("#homeMainSquare").css("opacity", 0 + getLocalPercent(22, 22.5) / 100);
		/*******************
		homeImgRea1
		*******************/
		// 0 a 55
	...
	function resizeText () {
		var containerW = $("#content").width(),
				// Main title
				mainRatio = ($.browser.webkit) ? 9.5 : 10.5,
				subRation = ($.browser.webkit) ? 7.5 : 8.5,
				// Screen title
				stMainRatio = ($.browser.webkit) ? 7.2 : 8.2,
				stSubRatio = ($.browser.webkit) ? 16 : 17,
				// Age main
				ageMainRatio = 5.9,
				// Age right
				ageRightRatio = 25,
